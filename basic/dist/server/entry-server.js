...
const Bot = ({ isPopup = false, onClose, web_data }) => {
  ...
  const renderMessages = () => messages.map((m, i) => /* @__PURE__ */ jsxs("div", { className: m.sender === "user" ? "user-msg" : "bot-msg", children: [
  ...
  const content = /* @__PURE__ */ jsxs("div", { className: "msg-window", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "chat-window", children: [
      renderMessages(),
      renderButtons(),
      loading2 && /* @__PURE__ */ jsx("p", { className: "typing-indicator", children: "tapBot is typing…" })
    ] }),
